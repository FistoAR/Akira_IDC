...
// set data
var $url = 'https://www.fist-o.com/AkiraControls/index.html';
var $shared = false;
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var preloaderaudio = document.getElementById('preloader-audio');

  setTimeout(function () {
    const preloader = document.querySelector('.preloader');
    preloader.classList.add('over');
    var playau = preloaderaudio.autoplay;
    document.getElementById("viewer").innerHTML = playau;
